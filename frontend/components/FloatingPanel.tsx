...
export const FloatingPanel: React.FC<FloatingPanelProps> = ({
  ...
  return (
    <div
      ref={panelRef}
      className="absolute z-[100] flex flex-col bg-gray-900/95 backdrop-blur-md border border-gray-700 rounded-lg shadow-2xl overflow-hidden touch-none"
      style={{
        left: position.x,
        top: position.y,
        width: size.width,
    ...
    >
      {/* Header / Drag Handle */}
      <div
        className="h-8 bg-blue-900 border-b border-gray-700 flex items-center justify-between px-2 cursor-move select-none touch-none shrink-0"
